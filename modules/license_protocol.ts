...
export function licenseRequest_ContentIdentification_InitData_InitDataTypeFromJSON(object: any): LicenseRequest_ContentIdentification_InitData_InitDataType {
    switch (object) {
        case 1:
        case 'CENC':
...
export function licenseRequest_ContentIdentification_InitData_InitDataTypeToJSON(object: LicenseRequest_ContentIdentification_InitData_InitDataType): string {
    switch (object) {
...
export function clientIdentification_ClientCapabilities_CertificateKeyTypeFromJSON(object: any): ClientIdentification_ClientCapabilities_CertificateKeyType {
    switch (object) {
        case 0:
        case 'RSA_2048':
...
export function clientIdentification_ClientCapabilities_CertificateKeyTypeToJSON(object: ClientIdentification_ClientCapabilities_CertificateKeyType): string {
    switch (object) {
...
export function clientIdentification_ClientCapabilities_AnalogOutputCapabilitiesFromJSON(object: any): ClientIdentification_ClientCapabilities_AnalogOutputCapabilities {
    switch (object) {
        case 0:
...
export function clientIdentification_ClientCapabilities_AnalogOutputCapabilitiesToJSON(object: ClientIdentification_ClientCapabilities_AnalogOutputCapabilities): string {
    switch (object) {
...
export const License = {
    ...
    fromJSON(object: any): License {
        return {
            ...
            platformVerificationStatus: isSet(object.platformVerificationStatus) ? platformVerificationStatusFromJSON(object.platformVerificationStatus) : 0,
    ...
    toJSON(message: License): unknown {
        ...
        message.srmRequirement !== undefined && (obj.srmRequirement = base64FromBytes(message.srmRequirement !== undefined ? message.srmRequirement : Buffer.alloc(0)));
        message.srmUpdate !== undefined && (obj.srmUpdate = base64FromBytes(message.srmUpdate !== undefined ? message.srmUpdate : Buffer.alloc(0)));
        message.platformVerificationStatus !== undefined && (obj.platformVerificationStatus = platformVerificationStatusToJSON(message.platformVerificationStatus));
        if (message.groupIds) {
    ...
    fromPartial<I extends Exact<DeepPartial<License>, I>>(object: I): License {
        ...
        message.licenseStartTime = object.licenseStartTime !== undefined && object.licenseStartTime !== null ? Long.fromValue(object.licenseStartTime) : Long.ZERO;
...
export const License_Policy = {
    ...
    fromJSON(object: any): License_Policy {
        return {
            ...
            renewalRecoveryDurationSeconds: isSet(object.renewalRecoveryDurationSeconds) ? Long.fromValue(object.renewalRecoveryDurationSeconds) : Long.ZERO,
    ...
    toJSON(message: License_Policy): unknown {
        ...
        message.renewalRecoveryDurationSeconds !== undefined && (obj.renewalRecoveryDurationSeconds = (message.renewalRecoveryDurationSeconds || Long.ZERO).toString());
        ...
        message.renewalRetryIntervalSeconds !== undefined && (obj.renewalRetryIntervalSeconds = (message.renewalRetryIntervalSeconds || Long.ZERO).toString());
        ...
        message.playStartGracePeriodSeconds !== undefined && (obj.playStartGracePeriodSeconds = (message.playStartGracePeriodSeconds || Long.ZERO).toString());
    ...
    fromPartial<I extends Exact<DeepPartial<License_Policy>, I>>(object: I): License_Policy {
        ...
        message.playbackDurationSeconds =
            object.playbackDurationSeconds !== undefined && object.playbackDurationSeconds !== null ? Long.fromValue(object.playbackDurationSeconds) : Long.ZERO;
        message.licenseDurationSeconds =
            object.licenseDurationSeconds !== undefined && object.licenseDurationSeconds !== null ? Long.fromValue(object.licenseDurationSeconds) : Long.ZERO;
        ...
        message.renewalDelaySeconds = object.renewalDelaySeconds !== undefined && object.renewalDelaySeconds !== null ? Long.fromValue(object.renewalDelaySeconds) : Long.ZERO;
        message.renewalRetryIntervalSeconds =
            object.renewalRetryIntervalSeconds !== undefined && object.renewalRetryIntervalSeconds !== null ? Long.fromValue(object.renewalRetryIntervalSeconds) : Long.ZERO;
        ...
        message.playStartGracePeriodSeconds =
            object.playStartGracePeriodSeconds !== undefined && object.playStartGracePeriodSeconds !== null ? Long.fromValue(object.playStartGracePeriodSeconds) : Long.ZERO;
...
export const License_KeyContainer = {
    ...
    toJSON(message: License_KeyContainer): unknown {
        ...
        message.keyControl !== undefined && (obj.keyControl = message.keyControl ? License_KeyContainer_KeyControl.toJSON(message.keyControl) : undefined);
        ...
        if (message.videoResolutionConstraints) {
            obj.videoResolutionConstraints = message.videoResolutionConstraints.map((e) => (e ? License_KeyContainer_VideoResolutionConstraint.toJSON(e) : undefined));
        } else {
    ...
    fromPartial<I extends Exact<DeepPartial<License_KeyContainer>, I>>(object: I): License_KeyContainer {
        ...
        message.requestedProtection =
            object.requestedProtection !== undefined && object.requestedProtection !== null
                ...
                : undefined;
        message.keyControl = object.keyControl !== undefined && object.keyControl !== null ? License_KeyContainer_KeyControl.fromPartial(object.keyControl) : undefined;
        message.operatorSessionKeyPermissions =
            object.operatorSessionKeyPermissions !== undefined && object.operatorSessionKeyPermissions !== null
                ...
                : undefined;
        message.videoResolutionConstraints = object.videoResolutionConstraints?.map((e) => License_KeyContainer_VideoResolutionConstraint.fromPartial(e)) || [];
...
export const License_KeyContainer_KeyControl = {
    ...
    toJSON(message: License_KeyContainer_KeyControl): unknown {
        const obj: any = {};
        message.keyControlBlock !== undefined && (obj.keyControlBlock = base64FromBytes(message.keyControlBlock !== undefined ? message.keyControlBlock : Buffer.alloc(0)));
        message.iv !== undefined && (obj.iv = base64FromBytes(message.iv !== undefined ? message.iv : Buffer.alloc(0)));
        return obj;
    },
...
export const LicenseRequest = {
    ...
    fromJSON(object: any): LicenseRequest {
        return {
            ...
            keyControlNonceDeprecated: isSet(object.keyControlNonceDeprecated) ? Buffer.from(bytesFromBase64(object.keyControlNonceDeprecated)) : Buffer.alloc(0),
    ...
    toJSON(message: LicenseRequest): unknown {
        ...
        message.contentId !== undefined && (obj.contentId = message.contentId ? LicenseRequest_ContentIdentification.toJSON(message.contentId) : undefined);
        ...
        message.keyControlNonceDeprecated !== undefined &&
            (obj.keyControlNonceDeprecated = base64FromBytes(message.keyControlNonceDeprecated !== undefined ? message.keyControlNonceDeprecated : Buffer.alloc(0)));
    ...
    fromPartial<I extends Exact<DeepPartial<LicenseRequest>, I>>(object: I): LicenseRequest {
        ...
        message.contentId = object.contentId !== undefined && object.contentId !== null ? LicenseRequest_ContentIdentification.fromPartial(object.contentId) : undefined;
        message.type = object.type ?? 1;
        ...
        message.encryptedClientId =
            object.encryptedClientId !== undefined && object.encryptedClientId !== null ? EncryptedClientIdentification.fromPartial(object.encryptedClientId) : undefined;
        return message;
    }
};
...
export const LicenseRequest_ContentIdentification = {
    ...
    fromJSON(object: any): LicenseRequest_ContentIdentification {
        return {
            widevinePsshData: isSet(object.widevinePsshData) ? LicenseRequest_ContentIdentification_WidevinePsshData.fromJSON(object.widevinePsshData) : undefined,
            webmKeyId: isSet(object.webmKeyId) ? LicenseRequest_ContentIdentification_WebmKeyId.fromJSON(object.webmKeyId) : undefined,
            existingLicense: isSet(object.existingLicense) ? LicenseRequest_ContentIdentification_ExistingLicense.fromJSON(object.existingLicense) : undefined,
    ...
    toJSON(message: LicenseRequest_ContentIdentification): unknown {
        ...
        message.widevinePsshData !== undefined &&
            (obj.widevinePsshData = message.widevinePsshData ? LicenseRequest_ContentIdentification_WidevinePsshData.toJSON(message.widevinePsshData) : undefined);
        message.webmKeyId !== undefined && (obj.webmKeyId = message.webmKeyId ? LicenseRequest_ContentIdentification_WebmKeyId.toJSON(message.webmKeyId) : undefined);
        message.existingLicense !== undefined &&
            (obj.existingLicense = message.existingLicense ? LicenseRequest_ContentIdentification_ExistingLicense.toJSON(message.existingLicense) : undefined);
        message.initData !== undefined && (obj.initData = message.initData ? LicenseRequest_ContentIdentification_InitData.toJSON(message.initData) : undefined);
        return obj;
    },
    ...
    fromPartial<I extends Exact<DeepPartial<LicenseRequest_ContentIdentification>, I>>(object: I): LicenseRequest_ContentIdentification {
        ...
        message.widevinePsshData =
            object.widevinePsshData !== undefined && object.widevinePsshData !== null
                ...
                : undefined;
        message.webmKeyId = object.webmKeyId !== undefined && object.webmKeyId !== null ? LicenseRequest_ContentIdentification_WebmKeyId.fromPartial(object.webmKeyId) : undefined;
        message.existingLicense =
            object.existingLicense !== undefined && object.existingLicense !== null
                ...
                : undefined;
        message.initData = object.initData !== undefined && object.initData !== null ? LicenseRequest_ContentIdentification_InitData.fromPartial(object.initData) : undefined;
        return message;
    }
};
...
export const LicenseRequest_ContentIdentification_ExistingLicense = {
    ...
    fromPartial<I extends Exact<DeepPartial<LicenseRequest_ContentIdentification_ExistingLicense>, I>>(object: I): LicenseRequest_ContentIdentification_ExistingLicense {
        ...
        message.secondsSinceStarted = object.secondsSinceStarted !== undefined && object.secondsSinceStarted !== null ? Long.fromValue(object.secondsSinceStarted) : Long.ZERO;
        message.secondsSinceLastPlayed =
            object.secondsSinceLastPlayed !== undefined && object.secondsSinceLastPlayed !== null ? Long.fromValue(object.secondsSinceLastPlayed) : Long.ZERO;
...
export const SignedMessage = {
    ...
    toJSON(message: SignedMessage): unknown {
        ...
        message.remoteAttestation !== undefined && (obj.remoteAttestation = base64FromBytes(message.remoteAttestation !== undefined ? message.remoteAttestation : Buffer.alloc(0)));
        if (message.metricData) {
            obj.metricData = message.metricData.map((e) => (e ? MetricData.toJSON(e) : undefined));
        } else {
            obj.metricData = [];
        }
        message.serviceVersionInfo !== undefined && (obj.serviceVersionInfo = message.serviceVersionInfo ? VersionInfo.toJSON(message.serviceVersionInfo) : undefined);
    ...
    fromPartial<I extends Exact<DeepPartial<SignedMessage>, I>>(object: I): SignedMessage {
        ...
        message.serviceVersionInfo = object.serviceVersionInfo !== undefined && object.serviceVersionInfo !== null ? VersionInfo.fromPartial(object.serviceVersionInfo) : undefined;
...
export const ClientIdentification = {
    ...
    fromJSON(object: any): ClientIdentification {
        return {
            ...
            deviceCredentials: Array.isArray(object?.deviceCredentials) ? object.deviceCredentials.map((e: any) => ClientIdentification_ClientCredentials.fromJSON(e)) : []
        };
    },
...
export const ClientIdentification_ClientCapabilities = {
    ...
    toJSON(message: ClientIdentification_ClientCapabilities): unknown {
        ...
        if (message.supportedCertificateKeyType) {
            obj.supportedCertificateKeyType = message.supportedCertificateKeyType.map((e) => clientIdentification_ClientCapabilities_CertificateKeyTypeToJSON(e));
        } else {
...
export const EncryptedClientIdentification = {
    ...
    fromJSON(object: any): EncryptedClientIdentification {
        return {
            ...
            serviceCertificateSerialNumber: isSet(object.serviceCertificateSerialNumber) ? Buffer.from(bytesFromBase64(object.serviceCertificateSerialNumber)) : Buffer.alloc(0),
    ...
    toJSON(message: EncryptedClientIdentification): unknown {
        ...
        message.serviceCertificateSerialNumber !== undefined &&
            (obj.serviceCertificateSerialNumber = base64FromBytes(message.serviceCertificateSerialNumber !== undefined ? message.serviceCertificateSerialNumber : Buffer.alloc(0)));
        message.encryptedClientId !== undefined && (obj.encryptedClientId = base64FromBytes(message.encryptedClientId !== undefined ? message.encryptedClientId : Buffer.alloc(0)));
...
export const DrmCertificate = {
    ...
    toJSON(message: DrmCertificate): unknown {
        ...
        message.serialNumber !== undefined && (obj.serialNumber = base64FromBytes(message.serialNumber !== undefined ? message.serialNumber : Buffer.alloc(0)));
        ...
        message.encryptionKey !== undefined && (obj.encryptionKey = message.encryptionKey ? DrmCertificate_EncryptionKey.toJSON(message.encryptionKey) : undefined);
        return obj;
    },
    ...
    fromPartial<I extends Exact<DeepPartial<DrmCertificate>, I>>(object: I): DrmCertificate {
        ...
        message.encryptionKey = object.encryptionKey !== undefined && object.encryptionKey !== null ? DrmCertificate_EncryptionKey.fromPartial(object.encryptionKey) : undefined;
        return message;
    }
};
...
export const SignedDrmCertificate = {
    ...
    toJSON(message: SignedDrmCertificate): unknown {
        const obj: any = {};
        message.drmCertificate !== undefined && (obj.drmCertificate = base64FromBytes(message.drmCertificate !== undefined ? message.drmCertificate : Buffer.alloc(0)));
        message.signature !== undefined && (obj.signature = base64FromBytes(message.signature !== undefined ? message.signature : Buffer.alloc(0)));
...
export const WidevinePsshData = {
    ...
    toJSON(message: WidevinePsshData): unknown {
        ...
        message.groupedLicense !== undefined && (obj.groupedLicense = base64FromBytes(message.groupedLicense !== undefined ? message.groupedLicense : Buffer.alloc(0)));
        return obj;
    },
...
export const WidevinePsshData_EntitledKey = {
    ...
    toJSON(message: WidevinePsshData_EntitledKey): unknown {
        const obj: any = {};
        message.entitlementKeyId !== undefined && (obj.entitlementKeyId = base64FromBytes(message.entitlementKeyId !== undefined ? message.entitlementKeyId : Buffer.alloc(0)));
